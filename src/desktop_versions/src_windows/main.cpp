...
struct context
{
	...
	int g;
	int b;
	SDL_Rect renderLocation = {0, 0, 960, 720};
	SDL_Rect clipRect = {0, 0, 960, 720};
...
int main(int argc, char *args[])
{
   ...
   // SDL_SetWindowFullscreen(window, SDL_WINDOW_FULLSCREEN);
	...
	Mix_Chunk *m_theme = Mix_LoadWAV("LetOurVoicesRiseLikeIncense.ogg");
	int canPlay = Mix_PlayChannel(-1, m_theme, 1);
	SDL_Surface *spriteSurface = IMG_Load("title.jpg");
